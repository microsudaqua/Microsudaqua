...
**2023**
* Fermani P., Gerea M., Graziano M., Mateus-Barros E., Sabio y García C., Sánchez M. L. & Schiaffino R. _2023_. __Protocols of standadization and water sampling in Latin America.__ ({{% staticref "files/Libro de Protocolos Microobservatorio_1era edicion_dic2023.pdf" "newtab" %}} es version {{% /staticref %}}| {{% staticref "files/Livro de Protocolos Observatorio Microbiano_1a_edição_Maio2024.pdf" "newtab" %}} pt version {{% /staticref %}})